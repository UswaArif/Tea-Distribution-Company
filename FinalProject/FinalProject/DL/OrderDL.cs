...
namespace SignIn.DL
{
    class OrderDL
    {
        ...
        public static void StoreIntoFile(string path, OrderBL o1)
        {
            ...
            f.WriteLine(o1.OrderID1 + "," + o1.OrderCustomer1.CusName1 + "," + o1.OrderCustomer1.CusEmail1 + "," + o1.OrderCustomer1.CusLedger1 + "," + o1.OrderCustomer1.IsFrequenter1 + "," + o1.OrderCustomer1.CusCinic1 + "," + o1.OrderCustomer1.CusAddress1.Latitude1 + "," + o1.OrderCustomer1.CusAddress1.Longitude1  + "," + o1.OrderPaid1 + "," + o1.OrderMonth1 + "," + o1.OrderDeliveryDate1+","+o1.OrderPayment1 + "," + o1.OrderRider1.EmpName1 +","+o1.OrderRider1.EmpCnic1+ "," +","+o1.OrderRider1.EmpPhone1+","+o1.OrderRider1.EmpId1+","+o1.OrderRider1.EmpSalary1+"," +o1.OrderRider1.VehicleId1+","+o1.OrderRider1.TotalDelivery1+","+o1.OrderRider1.IsSalaryPaid+","+o1.OrderRider1.RiderArea1.Latitude1+","+o1.OrderRider1.RiderArea1.Longitude1+","+product);
            f.Flush();
            f.Close();
        }
