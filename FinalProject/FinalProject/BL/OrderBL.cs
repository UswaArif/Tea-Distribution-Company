...
namespace SignIn.BL
{
    public class OrderBL
    {
        ...
        public OrderBL(string orderID, CustomerBL orderCustomer, LinkedList<ProductBL> orderProduct, string orderMonth, bool orderPaid, RiderBL orderRider, string orderDeliveryDate)
        {
            OrderID1 = orderID;
